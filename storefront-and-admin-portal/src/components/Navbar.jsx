...
export default memo(function Navbar({ currentPage, onNavigate, onOpenAuth, onOpenBag }) {
  ...
  const { isAuthenticated, logout, localUser, isAdmin } = useAuth();
              ...
              <div className="flex items-center gap-2">
                {isAdmin && (
                  <button
                    ...
                    className="flex items-center gap-1.5 text-brand-gold hover:text-brand-gold-light transition-colors text-xs font-black uppercase tracking-widest border-r border-brand-gold/15 pr-3 cursor-pointer"
                  >
                    <span>Admin ✦</span>
                  </button>
                )}
                ...
                <div className="flex flex-col gap-4">
                  ...
                  {isAdmin && (
                    <motion.button
                      ...
                      className="text-left py-2.5 text-xs font-black tracking-[0.25em] text-brand-gold hover:text-brand-gold-light transition-colors border-b border-brand-gold/5 flex items-center justify-between"
                    >
