...
const faqData: FAQItem[] = [
  ...
  {
    id: 4,
    question: "How do I finalize my inquiry and complete the order?",
    answer: "Once you fill out your delivery details on our storefront, click the gold button to copy the order summary and redirect to Facebook Messenger. Simply paste the pre-copied summary in our chat, and our concierge will verify stock and coordinate payment/delivery!",
    icon: Compass
  }
];
